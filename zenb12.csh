...
if(-d 'result12/graph1/tmp')then
else
mkdir result12/graph1/tmp
endif
...
if(-d 'result12/graph1/'$i'_'$j'_g1')then
rm -r  ./result12/graph1/"$i"_"$j"_g1
endif
mv  ./result12/graph1/tmp  ./result12/graph1/"$i"_"$j"_g1
